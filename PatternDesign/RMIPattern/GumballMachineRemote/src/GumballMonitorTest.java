...
public class GumballMonitorTest {
    ...
    public static void main(String[] args) {
        String[] locations = {"rmi://santafe.mightygumball.com/gumballmachine", "rmi://boulder" +
                ".mightygumball.com/gumballmachine", "rmi://seattle.mightygumball" +
                ".com/gumballmachine"};
